      ...
      <header className="inset-x-0 top-0 z-50">
        ...
        >
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            <a
              href="/encuesta/bienvenida"
              className="text-sm/6 font-semibold text-gray-900 hover:text-violet-500"
            >
              Bienvenida
            </a>
            <a
        ...
        >
          ...
          <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            ...
            <div className="flow-root w-full">
              ...
              <button
                onClick={handleLogout}
                className="rounded-md border border-violet-600 px-3.5 py-2.5 text-base/7 font-semibold text-violet-600 shadow-xs hover:bg-violet-500 hover:text-white transition-colors duration-200 block w-full text-center"
              >
                Logout
              </button>
            </div>
